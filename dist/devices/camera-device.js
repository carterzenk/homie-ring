...
(function (CameraProps) {
    CameraProps["SNAPSHOT_DATA"] = "snapshot_data";
    CameraProps["SNAPSHOT_LAST_UPDATED"] = "snapshot_last_updated";
})(CameraProps || (CameraProps = {}));
;
var BatteryProps;
(function (BatteryProps) {
    BatteryProps["LEVEL"] = "level";
    BatteryProps["IS_LOW"] = "is_low";
})(BatteryProps || (BatteryProps = {}));
var LightProps;
(function (LightProps) {
    LightProps["STATUS"] = "status";
})(LightProps || (LightProps = {}));
;
class CameraDevice extends base_device_1.BaseDevice {
    batteryNode;
    lightNode;
    cameraNode;
    snapshotPublishInterval;
    constructor(logger, settings, ringDevice, locationId, snapshotPollingSeconds) {
...
//# sourceMappingURL=camera-device.js.map